...
Este proyecto implementa un sistema de **RAG (Retrieval-Augmented Generation)** local. Permite "chatear" con tus propios documentos PDF. El sistema indexa los documentos en una base de datos vectorial y utiliza un LLM (Llama 3.2) para responder preguntas basándose estrictamente en el contenido de esos archivos.

## 🚀 Características

* **Procesamiento de Documentos:** Carga y divide archivos PDF de la carpeta `data/`.
...
├── data/                 # ¡CARPETA IMPORTANTE! Pon tus PDFs aquí
